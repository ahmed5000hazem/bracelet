<div x-cloak x-data="sidebar()" class="relative flex items-start col-span-1 h-full">
    <div class="absolute top-0 z-40 transition-all duration-300">
        <div class="flex justify-end">
            <button @click="sidebarOpen = !sidebarOpen"
                ...
                class="transition-all duration-300 w-8 p-1 mx-3 mt-6 my-2 rounded-full focus:outline-none">
    ...
    <div x-cloak wire:ignore :class="{ 'w-56': sidebarOpen, 'right-0': !sidebarOpen }"
        class="fix ed w-f ull top-0 bottom-0 left-0 z-30 block md:w-56 h-full min-h-screen overflow-y-auto text-gray-400 transition-all duration-300 ease-in-out bg-gray-900 shadow-lg overflow-x-hidden">
        ...
        <div class="flex flex-col items-stretch justify-between h-full">
            <div class="flex flex-col flex-shrink-0 w-full">
                <div class="flex items-center justify-center px-8 py-3 text-center">
                    <a href="#" class="text-lg mt-4 leading-normal text-gray-200 focus:outline-none focus:ring">My
                        App</a>
                </div>
                ...
                <nav>
                    <div class="flex-grow md:block md:overflow-y-auto overflow-x-hidden"
                        ...
                        <a class="flex items-center mt-6 px-4 py-3 hover:bg-gray-800 focus:bg-gray-800 hover:text-gray-400 focus:outline-none focus:ring"
                            href="#">
